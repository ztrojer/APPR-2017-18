...
Prikaz držav, ki proizvedejo največ energije v Evropi skozi časovno obdobje 1990 – 2015. Opazimo, da zelo izstopa Nemčija. Od leta 1990 do 2002 ima Nemčija čedalje več proizvedene energije, od leta 2002 pa ima različna nihanja. Razlog je najbrž v zapiranju nemških jedrskih elektrarn po letu 2011.
Države, ki proizvedejo najmanj energije pa so: Črna Gora, Malta, Luxembourg in Litva.

```{r graf1, echo=FALSE, message=FALSE, warning=FALSE}
graf1
```

Prikaz prodaje električnih avtomobilov in hibridov v Evropi. Dokaj nizka prodaja električnih avtomobilov je posledica visoke cene le teh, saj so se električni avtomobili prebili na trg šele v 21. stoletju.
...
Delež električne energije iz obnovljivih virov: pričakoval sem, da bodo tu izstopale severne države, presenetila pa me je Albanija, ki ima višji delež kot Švedska in Avstrija. 
